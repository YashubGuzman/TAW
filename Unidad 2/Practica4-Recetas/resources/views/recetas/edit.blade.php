...
<div class="row justify-content-center mt-5">
    <div class="col-md-8">
        <form method="POST" action="{{route('recetas.update')}}"
            ...
            <div class="form-group mt-3">
                ...
                <input id="id" type="hidden" name="id" value="{{$recetas[0]->id_receta}}">
            </div>
                    ...
                    <input type="text"
                        ...
                        @enderror
                            ...
                            <div class="form-group mt-3">
                                ...
                                <!--Campo de text de preparación, se agrega el elemento OLD para que no se elimine al actualizar la pagina -->
                                <input id="preparacion" type="hidden" name="preparacion" value="{{$recetas[0]->preparacion}}">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <!--Campo de text de preparación, se agrega el elemento OLD para que no se elimine al actualizar la pagina -->
                                <input id="ingredientes" type="hidden" name="ingredientes" value="{{$recetas[0]->ingredientes}}">
                                <!--Agregamos el editor -->
                                <trix-editor
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input
                                    ...
                                    <!--Informa sobre que pasa si no sube una imagen-->
                                    Si no se selecciona una imagen se conservara la actual
            ...
            <!--Botón-->
            <div class="form-group">
                <input type="submit" class="btn btn-dark" value="Actualizar receta" data-toggle="modal" data-target="#exampleModal">
            </div>
        </form>
    </div>
</div>
